...
export const filterOptions: FilterOptions[] = [
  {
    id: 1,
    options: [
      CHARACTER_FILTER_VALUES.ALL,
      CHARACTER_FILTER_VALUES.STARRED,
      CHARACTER_FILTER_VALUES.OTHERS,
    ],
    name: 'Character',
    value: 'characterType',
  },
  {
    id: 2,
    options: [SPECIES_FILTER_VALUES.ALL, SPECIES_FILTER_VALUES.HUMAN, SPECIES_FILTER_VALUES.ALIEN],
    name: 'Species',
    value: 'species',
  },
  {
    id: 3,
    options: [
      STATUS_FILTER_VALUES.ALL,
      STATUS_FILTER_VALUES.ALIVE,
      STATUS_FILTER_VALUES.DEAD,
      STATUS_FILTER_VALUES.UNKNOWN,
    ],
    name: 'Status',
    value: 'status',
  },
  {
    ...
    options: [
      ...
      GENDER_FILTER_VALUES.GENDERLESS,
      GENDER_FILTER_VALUES.UNKNOWN,
    ],
    name: 'Gender',
    value: 'gender',
  },
