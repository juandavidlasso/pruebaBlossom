export const swaggerDocument = {
            ...
            "application/json": {
              ...
              examples: {
                allCharacters: {
                  ...
                  value: {
                    query:
                      "{ characters(filter: {}) { id name status species gender origin location image } }",
                  },
                },
                filterByStatus: {
                  ...
                  value: {
                    query:
                      '{ characters(filter: { status: "Alive" }) { id name status species } }',
                  },
                },
                filterBySpecies: {
                  ...
                  value: {
                    query:
                      '{ characters(filter: { species: "Human" }) { id name species gender } }',
                  },
                },
                filterByGender: {
                  ...
                  value: {
                    query:
                      '{ characters(filter: { gender: "Male" }) { id name gender } }',
                  },
                },
                filterByName: {
                  ...
                  value: {
                    query:
                      '{ characters(filter: { name: "Rick" }) { id name status species } }',
                  },
                },
                filterByOrigin: {
                  ...
                  value: {
                    query:
                      '{ characters(filter: { origin: "Earth" }) { id name origin } }',
                  },
                },
                multipleFilters: {
                  ...
                  value: {
                    query:
                      '{ characters(filter: { status: "Alive", species: "Human", gender: "Male" }) { id name status species gender origin } }',
                  },
                },
                getFavorites: {
                ...
                toggleFavorite: {
                  ...
                  value: {
                    query:
                      "mutation { toggleFavorite(characterId: 1) { isFavorite characterId } }",
                  },
                },
                getComments: {
                  ...
                  value: {
                    query:
                      "{ comments(characterId: 1) { id content createdAt } }",
                  },
                },
                addComment: {
                  ...
                  value: {
                    query:
                      'mutation { addComment(characterId: 1, content: "Rick es el mejor!") { id content createdAt } }',
                  },
                },
                deleteComment: {
  ...
  tags: [
    {
      name: "GraphQL",
      description: "Endpoint GraphQL para queries y mutations",
    },
