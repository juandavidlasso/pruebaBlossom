...
vi.mock('../src/models', () => ({
  ...
  Character: { findAll: (...args: any[]) => mockFindAll(...args), hasMany: vi.fn(), hasOne: vi.fn() },
...
describe('CharacterService', () => {
  ...
  it('should return all characters when no filters are provided', async () => {
    const mockCharacters = [
      { id: 1, name: 'Rick Sanchez', status: 'Alive', species: 'Human', gender: 'Male', origin: 'Earth', location: 'Earth', image: 'url', type: '', created: '2017-11-04' },
      { id: 2, name: 'Morty Smith', status: 'Alive', species: 'Human', gender: 'Male', origin: 'Earth', location: 'Earth', image: 'url', type: '', created: '2017-11-04' }
    ];
  ...
  it('should filter by multiple fields simultaneously', async () => {
    const mockCharacters = [
      { id: 1, name: 'Rick Sanchez', status: 'Alive', species: 'Human', gender: 'Male', origin: 'Earth (C-137)', location: 'Earth', image: 'url', type: '', created: '2017-11-04' }
    ];
    mockFindAll.mockResolvedValue(mockCharacters);
